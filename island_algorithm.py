...
num_sub_pop = 5                         # number of subpopulations
...
tournament_size = 4                     # Number of individuals taking part in tournamnet selection 
sigma = 0.1                             # gene mutation probability 
migration_rate = 10                     # every how many generations communication occurs between subpopulation
migration_magnitude = 2                 # how many members cross over to a new island
