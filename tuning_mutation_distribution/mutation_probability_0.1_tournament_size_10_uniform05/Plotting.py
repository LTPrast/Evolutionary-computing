...
max_fitness = pd.read_csv('./mutation_probability_0.1_tournament_size_10_max_fitness.csv',delimiter=",")
mean_fitness = pd.read_csv('./mutation_probability_0.1_tournament_size_10_mean_fitness.csv',delimiter=",")
