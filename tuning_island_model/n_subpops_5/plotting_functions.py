...
def tuning_plot_mean_fitness(parameter_1, parameter_2, name_1, name_2):
    ...
    for par1 in parameter_1:
        ...
        for par2 in parameter_2:
            mean_fitness_cur = pd.read_csv(f'./migration_rate_{par1}_migration_magnitude_{par2}/migration_rate_{par1}_migration_magnitude_{par2}_mean_fitness.csv',delimiter=",")
...
def tuning_plot_max_fitness(parameter_1, parameter_2, name_1, name_2):
    ...
    for par1 in parameter_1:
        ...
        for par2 in parameter_2:
            max_fitness_cur = pd.read_csv(f'./migration_rate_{par1}_migration_magnitude_{par2}/migration_rate_{par1}_migration_magnitude_{par2}_max_fitness.csv',delimiter=",")
