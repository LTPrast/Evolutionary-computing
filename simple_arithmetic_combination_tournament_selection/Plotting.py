...
max_fitness = pd.read_csv('./simple_arithmetic_combination_tournament_selection_max_fitness.csv',delimiter=",")
mean_fitness = pd.read_csv('./simple_arithmetic_combination_tournament_selection_mean_fitness.csv',delimiter=",")
